...
final class _AMD_PltDeviceService_register extends IceInternal.IncomingAsync implements AMD_PltDeviceService_register
{
    public _AMD_PltDeviceService_register(IceInternal.Incoming in)
    {
        super(in);
    }
