...
final class _AMD_PltUserService_validationToken extends IceInternal.IncomingAsync implements AMD_PltUserService_validationToken
{
    public _AMD_PltUserService_validationToken(IceInternal.Incoming in)
    {
        super(in);
    }
