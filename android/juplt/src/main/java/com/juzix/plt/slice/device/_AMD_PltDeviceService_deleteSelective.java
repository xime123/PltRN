...
final class _AMD_PltDeviceService_deleteSelective extends IceInternal.IncomingAsync implements AMD_PltDeviceService_deleteSelective
{
    public _AMD_PltDeviceService_deleteSelective(IceInternal.Incoming in)
    {
        super(in);
    }
