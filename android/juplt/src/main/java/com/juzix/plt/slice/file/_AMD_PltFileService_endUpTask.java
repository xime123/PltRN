...
final class _AMD_PltFileService_endUpTask extends IceInternal.IncomingAsync implements AMD_PltFileService_endUpTask
{
    public _AMD_PltFileService_endUpTask(IceInternal.Incoming in)
    {
        super(in);
    }
