...
final class _AMD_PltFileService_smallFileUpload extends IceInternal.IncomingAsync implements AMD_PltFileService_smallFileUpload
{
    public _AMD_PltFileService_smallFileUpload(IceInternal.Incoming in)
    {
        super(in);
    }
