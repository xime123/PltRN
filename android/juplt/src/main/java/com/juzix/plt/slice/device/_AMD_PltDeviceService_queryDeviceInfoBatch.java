...
final class _AMD_PltDeviceService_queryDeviceInfoBatch extends IceInternal.IncomingAsync implements AMD_PltDeviceService_queryDeviceInfoBatch
{
    public _AMD_PltDeviceService_queryDeviceInfoBatch(IceInternal.Incoming in)
    {
        super(in);
    }
    ...
    public void ice_response(PltDeviceInfo[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                deviceInfoListHelper.write(__os, __ret);
