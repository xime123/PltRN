...
final class _AMD_PltFileService_bigFileUpload extends IceInternal.IncomingAsync implements AMD_PltFileService_bigFileUpload
{
    public _AMD_PltFileService_bigFileUpload(IceInternal.Incoming in)
    {
        super(in);
    }
