...
final class _AMD_PltUserService_queryUserInfo extends IceInternal.IncomingAsync implements AMD_PltUserService_queryUserInfo
{
    public _AMD_PltUserService_queryUserInfo(IceInternal.Incoming in)
    {
        super(in);
    }
    ...
    public void ice_response(PltUserInfo __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                PltUserInfo.__write(__os, __ret);
