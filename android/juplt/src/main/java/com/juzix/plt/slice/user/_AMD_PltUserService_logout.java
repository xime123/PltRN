...
final class _AMD_PltUserService_logout extends IceInternal.IncomingAsync implements AMD_PltUserService_logout
{
    public _AMD_PltUserService_logout(IceInternal.Incoming in)
    {
        super(in);
    }
