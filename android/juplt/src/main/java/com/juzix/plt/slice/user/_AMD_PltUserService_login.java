...
final class _AMD_PltUserService_login extends IceInternal.IncomingAsync implements AMD_PltUserService_login
{
    public _AMD_PltUserService_login(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(PltLoginResp __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                PltLoginResp.__write(__os, __ret);
