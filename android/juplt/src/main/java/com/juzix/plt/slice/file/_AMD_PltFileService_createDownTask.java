...
final class _AMD_PltFileService_createDownTask extends IceInternal.IncomingAsync implements AMD_PltFileService_createDownTask
{
    public _AMD_PltFileService_createDownTask(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(PltDownTaskResp __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                PltDownTaskResp.__write(__os, __ret);
