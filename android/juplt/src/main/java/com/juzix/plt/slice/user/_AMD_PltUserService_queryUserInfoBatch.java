...
final class _AMD_PltUserService_queryUserInfoBatch extends IceInternal.IncomingAsync implements AMD_PltUserService_queryUserInfoBatch
{
    public _AMD_PltUserService_queryUserInfoBatch(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(PltUserInfo[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                userInfoListHelper.write(__os, __ret);
