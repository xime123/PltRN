...
final class _AMD_PltFileService_fileDown extends IceInternal.IncomingAsync implements AMD_PltFileService_fileDown
{
    public _AMD_PltFileService_fileDown(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(PltFileDownResp __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                PltFileDownResp.__write(__os, __ret);
