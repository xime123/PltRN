...
final class _AMD_PltUserService_idleEnd extends IceInternal.IncomingAsync implements AMD_PltUserService_idleEnd
{
    public _AMD_PltUserService_idleEnd(IceInternal.Incoming in)
    {
        super(in);
    }
